    ...
    <body>
        ...
        <table id="tab" class="table table-bordered">
            <tr>
                ...
                <td class="test">
                    <a href="ControleurEleve?action=1er_semestre_compo&&annee=${annee}">1er Semestre</a>
                </td>
                <td class="test">
                    <a href="ControleurEleve?action=2eme_semestre_compo&&annee=${annee}">2nd Semestre</a>
                </td>
            </tr>
        </table>
