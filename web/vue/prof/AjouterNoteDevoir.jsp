                    ...
                    <c:forEach var="i" items="${eleve}">
                        <tbody>
                            <tr>
                                <td>${i.prenom}</td>
                                <td>${i.nom}</td>
                                <td><input id="note1" type="float" onkeypress='return event.charCode >= 46 && event.charCode <= 57' name="devoir" required="" maxlength="5" class="form-control" onkeyup="verifTaille()"/><span id="verifNote1"></span></td>
                            </tr>    
                        </tbody>
                    </c:forEach> 
                </table>
