            ...
            <div class="row">
                <div class="col-lg-12">                    
                    <form method="post" action="ControleurProf">
                        <input type="hidden" name="action" value="ajouterNoteComposition"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input id="note3" type="float" onkeypress='return event.charCode >= 46 && event.charCode <= 57' name="composition" required="" maxlength="5" class="form-control" onkeyup="verifTaille()"/><span id="verifNote3"></span>
                                            </div>
                                        </td>
                                    </tr>    
                                </tbody>
