...
public class ControleurEleve extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        else if ((action.equals("anneeScolaire")) || (action.equals("1er_semestre")) || (action.equals("2eme_semestre"))) {
        ...
        /////////////////////////////////////////////////Recherche////////////////////////////////////
            ...
            String login_pro= request.getParameter("login_pro");
              System.out.println("Test login prof "+login_pro);
            ...
            request.setAttribute("login", login_pro);
            ...
            System.out.println("Voir Test login prof "+pro_login);
            DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
            Date today = Calendar.getInstance().getTime();
            String date = df.format(today);
            daoEleve.insereReclamation(loginEleve, pro_login, message,"", date);
